...
public abstract class CriterionPanel<T extends PlausibilityCriterion> extends FXMLContainer implements SetObserver<SegmentType, PlausibilityCriterion> {
     ...
     * @return
     */
    public static CriterionPanel<? extends PlausibilityCriterion> forCriterion(LocalizedTextProvider translator, PlausibilityController controller, PlausibilityCriterion criterion) {
        switch (criterion.getType()) {
            case COMPATIBILITY:
                return new CompatibilityCriterionPanel(translator, controller, (CompatibilityCriterion) criterion);
            default:
                return null; //TODO?
        }
    }
