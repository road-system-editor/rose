 ...
 * Then it will subtract the given values and check, if the absolute difference is smaller than the legalDiscrepancy.
 *
...
abstract class ValidationStrategy<T> {
  ...
  /**
   * Validates if the difference between the two given values are smaller than the given legalDiscrepancy.
   ...
   * @return True if the given values are a legal combination in sense of the Strategy and the legalDiscrepancy.
   */
