...
/**
 * Describes a Strategy for exporting a {@link edu.kit.rose.model.roadsystem.RoadSystem}
...
abstract class ExportStrategy {
  ...
  /**
   * Exports the current {@link edu.kit.rose.model.roadsystem.RoadSystem} or Project into
   * the given File.
   *
