 ...
 * The {@link CriteriaManager} holds
 * {@link edu.kit.rose.model.plausibility.criteria.PlausibilityCriterion}
 * that will be applied to a {@link edu.kit.rose.model.roadsystem.RoadSystem}.
 * Possible violations will be added to the
 * {@link edu.kit.rose.model.plausibility.violation.ViolationManager}.
 */
public interface PlausibilitySystem {

  /**
   * Provides the ViolationManager this PlausibilitySystem uses.
   *
  ...
  /**
   * Provides the CriteriaManager this PlausibilitySystem uses.
   *
  ...
  /**
   * Checks all {@link edu.kit.rose.model.plausibility.criteria.PlausibilityCriterion} in the
   * {@link CriteriaManager}.
   * This is only supposed to be used when importing a new
   * {@link edu.kit.rose.model.roadsystem.RoadSystem} or a
